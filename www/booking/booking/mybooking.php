...
<div class="main-container ace-save-state" id="main-container">
 ...
 ?>
                        <p> <a class="btn btn-white btn-primary" href="index.php?page=booking" role="button"><i
                                    class="ace-icon glyphicon glyphicon-plus"></i>เพิ่ม</a>
                        <p>
...
?>
                                        <tr>
                                            ...
                                            <td>
                                                <span type="button" class="label label-sm label-pink"
                                            ...
                                            <td class="center">
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="green"
                                                        href="index.php?page=mybooking&action=edit&id=<?php echo $rs['id']; ?>">
                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                    <a class="red"
                                                        href="booking/action.php?action=change&id=<?php echo $rs['id']; ?>&status=<?php echo $rs['status']; ?>"
                                                        OnClick="return chk();">
                                                        <i class="ace-icon fa fa-gavel bigger-130"></i>
                                                    </a>
                                                    <?php } ?>
                                                    <a class="blue"
                                                        href="javascript:popup('booking/print.php?id=<?php echo $rs['id']; ?>','',680,500)">
                                                ...
                                                <div class="hidden-md hidden-lg">
                                                    <div class="inline pos-rel">
                                                        ...
                                                        <ul
                                                            ...
                                                            <?php if ($rs['status']=='0' || $rs['status']=='3' ) { ?>
                                                            <li>
                                                                <a href="index.php?page=mybooking&action=edit&id=<?php echo $rs['id']; ?>"
                                                            ...
                                                            <li>
                                                                <a href="booking/action.php?action=change&id=<?php echo $rs['id']; ?>&status=<?php echo $rs['status']; ?>"
                                                                    class="tooltip-info" data-rel="tooltip"
                                                                    title="เปลี่ยนสถานะ" OnClick="return chk();">
                                                                    <span class="blue">
                                                            ...
                                                            <?php } ?>
                                                            <li>
                                                                <a href="javascript:popup('booking/print.php?id=<?php echo $rs['id']; ?>','',680,500)"
    ...
    ?>
                        <form enctype="multipart/form-data" class="form-horizontal" role="form" name="formregister"
                            method="post" action="booking\action.php?action=edit">
                            <div class="page-header">
                                <h1>แก้ไข</h1>
                            </div>
 ...
 ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="membershow" placeholder="" class="col-xs-10 col-sm-5"
                                        value="<?php echo $rs['firstname'].'  '.$rs['surname'];?>" disabled />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="title" id="title" placeholder="" class="col-xs-10 col-sm-5"
                                        value="<?php echo $meResult2['title'];?>" required />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="startdatepicker">
                                    เริ่ม</label>
                                <div class="col-sm-2">
                                    <div class="input-group"> <input class="form-control datepicker" name="startdate"
                                            id="startdatepicker" type="text" data-date-format="yyyy-mm-dd"
                                            autocomplete="off"
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-1 control-label no-padding-right" for="endtime"> เวลา
                                </label>
                                <div class="col-sm-3">
 ...
 ?>
                            ...
                            <br>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="img_event">รูปภาพ</label>
                                <input type="file" name="img_event" id="img_event" OnChange="showPreview(this)"
                                    accept="image/*" value="<?php echo $meResult['img_event'];?>">
                            </div>
            ...
            function chk() {
                if (confirm('ต้องการเปลี่ยนสถานะหรือไม่ ยกเลิก/รออนุมัติ')) {
                    return true;
                } else {
                    return false;
                }
