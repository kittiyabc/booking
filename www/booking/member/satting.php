...
<div class="main-container ace-save-state" id="main-container">
 ...
 ?>
                        <p> <a class="btn btn-white btn-primary" href="index.php?page=member&action=add"
                        ...
                        <table id="dtBasicExample" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="center">สถานะการเข้าใช้</th>
...
?>
    ...
    ?></td>
                                    ...
                                    <td class="center">
                                        <?php if ($rs['status']=='admin'){echo '<span class="label label-sm label-warning">';} else {echo '<span class="label label-sm label-info">';}?><?=$rs['status']?></span>
                                    </td>
                                    <td class="center">
                                        <?php $rs['active'];if ($rs['active'] == 1){echo '<i class="ace-icon glyphicon glyphicon-ok"></i>';} else {echo '<i class="ace-icon glyphicon glyphicon-remove"></i>';}?>
                                    </td>
                                    <td class="center">
                                        <?php $dateLog=$rs['login_date']; echo thai_date_and_time(strtotime($dateLog)).' '.'('.$rs['login_times'].')'; ?>
                                    </td>
                                    <!--<td class="center"><?php// $dateData=$rs['create_date']; echo thai_date_and_time(strtotime($dateData)); ?></td>-->
                                    <td class="center">
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a class="green"
                                                href="index.php?page=member&action=edit&id=<?php echo $rs['id_member']; ?>">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>

                                            <a class="red"
                                                href="member/action.php?action=delete&id=<?php echo $rs['id_member']; ?>"
                                        ...
                                        <div class="hidden-md hidden-lg">
                                            <div class="inline pos-rel">
                                                ...
                                                <ul
                                                    ...
                                                    <li>
                                                        <a href="index.php?page=member&action=edit&id=<?php echo $rs['id_member']; ?>"
                                                            class="tooltip-success" data-rel="tooltip" title="แก้ไข">
                                                            <span class="green">
                                                                <i
                                                    ...
                                                    <li>
                                                        <a href="member/action.php?action=delete&id=<?php echo $rs['id_member']; ?>"
                        ...
                        <form class="form-horizontal" role="form" name="formregister" method="post"
                            action="member\action.php?action=add">
                            <div class="page-header">
                                <h1>เพิ่มสมาชิก</h1>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" name="txtConPassword" id="txtConPassword"
                                        placeholder="Password" class="col-xs-10 col-sm-5" value="" required />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right"
                                    for="position">สถานะการเข้าใช้</label>
                                <div class="col-sm-9">
    ...
    ?>
                        <form class="form-horizontal" role="form" name="formregister" method="post"
                            action="member\action.php?action=edit">
                            <div class="page-header">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="txtUsername" id="txtUsername" placeholder="Username"
                                        class="col-xs-10 col-sm-5" value="<?php echo $meResult['username'];?>"
                                        required />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" name="txtPassword" id="txtPassword" placeholder="Password"
                                        class="col-xs-10 col-sm-5" value="<?php echo $meResult['password'];?>"
                                        required />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" name="txtConPassword" id="txtConPassword"
                                        ...
                                        value="<?php echo $meResult['password'];?>" required />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="title"> คำนำหน้า
                                ...
                                <div class="col-sm-9">
                                    <select name="title" id="title">
                                        <option value="นาย"
                                            <?php if ($meResult['ntitle'] == 'นาย') {echo 'selected';}?>>นาย
                                        </option>
                                        <option value="นางสาว"
                                            <?php if ($meResult['ntitle'] == 'นางสาว') {echo 'selected';}?>>นางสาว
                                        </option>
                                        <option value="นาง"
                                            <?php if ($meResult['ntitle'] == 'นาง') {echo 'selected';}?>>นาง
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="txtfirstname" id="txtfirstname" placeholder="Firstname"
                                        class="col-xs-10 col-sm-5" value="<?php echo $meResult['firstname'];?>"
                                        required />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="txtsurname" id="txtsurname" placeholder="Surname"
                                        class="col-xs-10 col-sm-5" value="<?php echo $meResult['surname'];?>"
                                        required />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="position" id="position" placeholder="Position"
                                        class="col-xs-10 col-sm-5" value="<?php echo $meResult['position'];?>"
                                        required />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="phone" id="phone" placeholder="Phone"
                                        class="col-xs-10 col-sm-5" value="<?php echo $meResult['phone'];?>" required />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="txtemail"> อีเมลล์
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="txtemail" id="txtemail" placeholder="Email"
                                        class="col-xs-10 col-sm-5" value="<?php echo $meResult['email'];?>" required />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="status"> ระดับสิทธิ์
                                ...
                                <div class="col-sm-9">
                                    <select name="status" id="status">
                                        <option value="admin"
                                            <?php if ($meResult['status'] == 'admin') {echo 'selected';}?>>admin
                                        </option>
                                        <option value="user"
                                            <?php if ($meResult['status'] == 'user') {echo 'selected';}?>>user
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="active" id="active">
                                        <option value="1" <?php if ($meResult['active'] == '1') {echo 'selected';}?>>
                                            ใช้งานได้
                                        </option>
                                        <option value="0" <?php if ($meResult['active'] == '0') {echo 'selected';}?>>
                                            รอการยืนยัน
                                        </option>
                                    </select>
                                </div>
