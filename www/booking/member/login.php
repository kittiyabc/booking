...
<body>
    <div style="width:400px;margin:70px auto;">
        ...
        <form name="login" method="post" action="member/check_login.php">
            <div class="container">
                ...
                <input type="password" placeholder="Enter Password" name="password"
                    value="<?php if(isset($_COOKIE["passwordform"])) { echo $_COOKIE["passwordform"]; } ?>">

                <button type="submit">Login</button>
                <input name="remember" type="checkbox" id="remember" value="remember"
                    <?php if(isset($_COOKIE["userlogin"])) { ?> checked <?php }; ?> /> Remember me
            </div>
        ...
        <div style="text-align:center;vertical-align: middle;display: table-cell;">
            <span style="color:#555">Support : </span><img src="images/ie20.jpg"><span style="color:#555"> Internet
                Exproler </span><img src="images/chrome20.jpg"><span style="color:#555"> Chrome </span><img
                src="images/firefox20.jpg"><span style="color:#555"> Firefox</span>
        </div>
    </div>
