...
<div class="main-container ace-save-state" id="main-container">
    ...
    ?>
                        <form class="form-horizontal" role="form" name="formregister" method="post"
                            action="member\user_action.php?action=edit">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="title" id="title">
                                        <option value="นาย"
                                            <?php if ($meResult['ntitle'] == 'นาย') {echo 'selected';}?>>นาย</option>
                                        <option value="นางสาว"
                                            <?php if ($meResult['ntitle'] == 'นางสาว') {echo 'selected';}?>>นางสาว
                                        </option>
                                        <option value="นาง"
                                            <?php if ($meResult['ntitle'] == 'นาง') {echo 'selected';}?>>นาง</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" disabled>
                                        ...
                                        <option value="user"
                                            <?php if ($meResult['status'] == 'user') {echo 'selected';}?>>user</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
